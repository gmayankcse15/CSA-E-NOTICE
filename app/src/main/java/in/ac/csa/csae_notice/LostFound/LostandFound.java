package in.ac.csa.csae_notice.LostFound;
...
public class LostandFound extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("Lost and Found") ;
        ...
        imgview.setImageResource(R.drawable.lostfound);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("LostandFound").child("LOSTNotice");
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(LostandFound.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
                Globalclass mApp = ((Globalclass)getApplicationContext());
                mApp.setGlobalVariable(noticeMessages.size());
                mApp.setSectionVariable("LOSTNotice");
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(LostandFound.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
