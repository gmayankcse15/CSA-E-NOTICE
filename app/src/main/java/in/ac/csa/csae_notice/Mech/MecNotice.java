...
public class MecNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    private static final String TAG = "MecNotice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("PHOTOGRAPHY-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.photography);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("MEC").child("MECNotice");
            ...
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(MecNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                    }


                    Globalclass mApp = ((Globalclass)getApplicationContext());
                    mApp.setGlobalVariable(noticeMessages.size());
                    mApp.setSectionVariable("MECNotice");
     ...
     /*   }
        ...
        {
            Toast.makeText(MecNotice.this, "Not Authorized!!!", Toast.LENGTH_SHORT).show();
        }
        */
        /*
        mMessageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MecNotice.this, mecnoticedetail.class);
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(MecNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
