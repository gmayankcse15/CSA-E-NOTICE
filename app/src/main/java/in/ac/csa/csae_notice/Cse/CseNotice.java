...
public class CseNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    private static final String TAG = "CseNotice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("PROGRAMMING-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.computertop);


        //  FirebaseUser user = mFirebaseAuth.getCurrentUser();
        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("CSE").child("CSENotice");
            ...
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(CseNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    mApp.setSectionVariable("CSENotice");
   ...
   /* }
        ...
        {
            Toast.makeText(CseNotice.this, "Not Authorized!!!", Toast.LENGTH_SHORT).show();
        }
*/
...
/*
        mMessageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CseNotice.this, csenoticedetail.class);
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
             ...
             //   System.out.println("User"+user.getEmail()) ;
                ...
                if ((user != null)) {
                    Toast.makeText(CseNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
