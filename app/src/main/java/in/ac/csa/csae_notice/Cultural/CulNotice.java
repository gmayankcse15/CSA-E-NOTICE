package in.ac.csa.csae_notice.Cultural;
...
public class CulNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("CULTURAL-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.cultural);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("CULTURAL").child("CULTNotice");
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(CulNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
                Globalclass mApp = ((Globalclass)getApplicationContext());
                mApp.setGlobalVariable(noticeMessages.size());
                mApp.setSectionVariable("CULTNotice");
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(CulNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
