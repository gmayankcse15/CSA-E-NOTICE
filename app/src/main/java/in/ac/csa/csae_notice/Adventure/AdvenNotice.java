package in.ac.csa.csae_notice.Adventure;

/**
 * Created by mgupta on 11/29/2017.
 */
...
public class AdvenNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    private static final String TAG = "CivNotice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("ADVENTURE-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.adventure);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("ADVENTURE").child("ADVENotice");
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(AdvenNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
                Globalclass mApp = ((Globalclass)getApplicationContext());
                mApp.setGlobalVariable(noticeMessages.size());
                mApp.setSectionVariable("ADVENotice");
        ...
        {
            Toast.makeText(CivilNotice.this, "Not Authorized!!!", Toast.LENGTH_SHORT).show();
        }*/
/*
        mMessageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CivilNotice.this, civilnoticedetail.class);
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(AdvenNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
