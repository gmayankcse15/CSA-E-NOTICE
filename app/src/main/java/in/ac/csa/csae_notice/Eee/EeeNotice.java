...
public class EeeNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    private static final String TAG = "EeeNotice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("ROBOTICS-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.robots);

        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("EEE").child("EEENotice");
 ...
 // if(Field.equals("eee")) {
      mChildEventListener = new ChildEventListener() {
          ...
          public void onChildAdded(DataSnapshot dataSnapshot, String s) {
              ...
              if (dataSnapshot.exists()) {
                  ...
                  Toast.makeText(EeeNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
              }

              Globalclass mApp = ((Globalclass)getApplicationContext());
              mApp.setGlobalVariable(noticeMessages.size());
              mApp.setSectionVariable("EEENotice");
  ...
  {
      Toast.makeText(EeeNotice.this, "Not Authorized!!!", Toast.LENGTH_SHORT).show();
  }
*/
  /*
        mMessageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EeeNotice.this, eeenoticedetail.class);
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(EeeNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
