package in.ac.csa.csae_notice.Academic;
...
public class AcadNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("ACADEMIC-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.academic);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("ACADEMIC").child("ACADNotice");
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(AcadNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
                Globalclass mApp = ((Globalclass)getApplicationContext());
                mApp.setGlobalVariable(noticeMessages.size());
                mApp.setSectionVariable("ACADNotice");
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(AcadNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
