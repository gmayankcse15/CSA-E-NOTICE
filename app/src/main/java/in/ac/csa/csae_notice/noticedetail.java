...
// instantiate it within the onCreate method
        mProgressDialog = new ProgressDialog(noticedetail.this);
        ...
        mDatabase.child("NitukENotice").child("College").child("Detail").child("" + position).child("descr").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(noticedetail.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void downloadPDF(View view) {
        ...
        mDatabase.child("NitukENotice").child("College").child("pdf").child("" + position).child("link").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                  ...
                  //  register.setEnabled(false);
                    ...
                    if (isclick) {
                        ...
                        if (ContextCompat.checkSelfPermission(noticedetail.this,
                                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {

                            // Should we show an explanation?
                            if (ActivityCompat.shouldShowRequestPermissionRationale(noticedetail.this,
                                ...
                                ActivityCompat.requestPermissions(noticedetail.this,
                        ...
                        int permissionCheck = ContextCompat.checkSelfPermission(noticedetail.this,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE);

                        if (permissionCheck == PackageManager.PERMISSION_GRANTED) {
                            final DownloadTask downloadTask = new DownloadTask(noticedetail.this);
                    ...
                    Toast.makeText(noticedetail.this, "item not found!!!", Toast.LENGTH_SHORT).show();
                }
            }
