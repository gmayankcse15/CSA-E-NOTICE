...
public class ecenoticedetail extends AppCompatActivity {
    TextView textView;
    int position;
...
// instantiate it within the onCreate method
        mProgressDialog = new ProgressDialog(ecenoticedetail.this);
        ...
        mDatabase.child("NitukENotice").child("ECE").child("DetailECE").child("" + position).child("descr").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(ecenoticedetail.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void downloadPDF(View view) {
        ...
        mDatabase.child("NitukENotice").child("ECE").child("ECEpdf").child("" + position).child("link").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (isclick) {
                        ...
                        if (ContextCompat.checkSelfPermission(ecenoticedetail.this,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {

                            // Should we show an explanation?
                            if (ActivityCompat.shouldShowRequestPermissionRationale(ecenoticedetail.this,
                                    Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                ...
                                ActivityCompat.requestPermissions(ecenoticedetail.this,
                        ...
                        int permissionCheck = ContextCompat.checkSelfPermission(ecenoticedetail.this,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE);


                            if (permissionCheck == PackageManager.PERMISSION_GRANTED) {
                                final DownloadTask downloadTask = new DownloadTask(ecenoticedetail.this);
                    ...
                    Toast.makeText(ecenoticedetail.this, "item not found!!!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null)
                ...
                Toast.makeText(ecenoticedetail.this, "you can check your downloaded pdf in file manager also!!!!", Toast.LENGTH_SHORT).show();
