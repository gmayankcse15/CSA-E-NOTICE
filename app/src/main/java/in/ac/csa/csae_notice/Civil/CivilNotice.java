...
public class CivilNotice extends AppCompatActivity {
    int position;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout)).setTitle("TECHNICAL-NOTICE SECTION") ;
        ...
        imgview.setImageResource(R.drawable.tech);


        mMessageListView = (ListView) findViewById(R.id.messageListView);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessageDatabaseReference = mFirebaseDatabase.getReference().child("NitukENotice").child("CIVIL").child("CIVILNotice");
            ...
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(CivilNotice.this, "Database empty!!!", Toast.LENGTH_SHORT).show();
                    }
                    Globalclass mApp = ((Globalclass)getApplicationContext());
                    mApp.setGlobalVariable(noticeMessages.size());
                    mApp.setSectionVariable("CIVILNotice");
        ...
        */
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if ((user != null)) {
                    Toast.makeText(CivilNotice.this, "Welcome to E-NOTICE SECTION", Toast.LENGTH_SHORT).show();
                } else {
